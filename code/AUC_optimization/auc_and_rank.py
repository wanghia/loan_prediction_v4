...
def createFeaturesForAUC(X,Y, max_samples=None):
    ...
    # in case of extremely large amount of training data
    if num_positives > 10000:
        num_positives = 10000
    if num_negatives > 10000:
        num_negatives = 10000

    all_combinations = cartesian( [range(num_positives), range(num_negatives)] )
